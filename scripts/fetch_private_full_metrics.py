...
def write_to_excel(df, workbook_path, sheet_name="data_privateFullMetrics"):
...
'Ticker', 'longName',
    ...
    'leadInvestor', 'latestAmountRaised',
    'latestFundingDate', 'fundingToDate',
    'totalFundingRounds', 'latestShareClass',
    'fiftyTwoWeekLow', 'fiftyTwoWeekHigh',
    '52WeekChange', 'fiftyTwoWeekChangePercent','dateFounded', 'Timestamp'


]

rename_map = {
'Ticker': 'Ticker', 'longName': 'Name', 'website': 'Link',
    'industry': 'Industry', 'sector': 'Sector', 'city': 'City',
    'state': 'State', 'country': 'Country', 'fullTimeEmployees': 'Employees',
    'typeDisp': 'Type', 'exchange': 'Exchange',
    'latestImpliedValuation': 'Implied Val',
    'leadInvestor': 'Lead Inv', 'latestAmountRaised': 'Last Raise',
    'latestFundingDate': 'Last Raise Date', 'fundingToDate': 'Total Raise',
    'totalFundingRounds': 'Rounds', 'latestShareClass': 'Last Class',
    'fiftyTwoWeekLow': '52w Low', 'fiftyTwoWeekHigh': '52w High', '52WeekChange': '52w Chg',
    'fiftyTwoWeekChangePercent': '52w % Chg',
    'Timestamp': 'Timestamp', 'dateFounded': 'Founded'
}
...
try:
    ...
    df_final.to_csv(PRIVATE_OUTPUT, index=False)
