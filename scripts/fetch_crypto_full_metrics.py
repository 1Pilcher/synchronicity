...
def write_to_excel(df, workbook_path, sheet_name="data_cryptoFullMetrics"):
...
final_columns = [
'Ticker', 'name', 'coinMarketCapLink', 'twitter', 'typeDisp', 'fullExchangeName',
    'fiftyTwoWeekLow',
    'fiftyTwoWeekHigh', 'fiftyTwoWeekChangePercent', 'marketCap', 'circulatingSupply',
...
rename_map = {
'Ticker': 'Ticker', 'name': 'Name', 'coinMarketCapLink': 'Chart',
    'twitter': 'Twitter', 'typeDisp': 'Type', 'fullExchangeName': 'Exchange',
    'fiftyTwoWeekLow': '52w Low', 'fiftyTwoWeekHigh': '52w High',
    'fiftyTwoWeekChangePercent': '52w % Chg', 'marketCap': 'Mkt Cap',
    'circulatingSupply': 'Float', 'fiftyDayAverage': '50d Avg',
    'fiftyDayAverageChange': '50d Avg Chg', 'fiftyDayAverageChangePercent': '50d Avg % Chg',
    'twoHundredDayAverage': '200d Avg', 'twoHundredDayAverageChange': '200d Avg Chg',
    'twoHundredDayAverageChangePercent': '200d Avg % Chg',
...
try:
    ...
    df_final.to_csv(CRYPTO_OUTPUT, index=False)
