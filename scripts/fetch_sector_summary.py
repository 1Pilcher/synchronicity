...
hhi_df = pd.DataFrame(hhi_data).set_index("Sector")

# Merge with summary
summary = summary.merge(hhi_df, left_index=True, right_index=True)

# Bring Sector index back as column without triggering index export
summary = summary.reset_index(drop=False)

# Preferred column order
column_order = [
    "Sector", "# of Companies", "W/A P/E", "W/A EV/EBITDA", "T Mkt Cap", "T EV", "T Rev",
...
sheet_name = "data_Sectors"    # or wherever you want it
