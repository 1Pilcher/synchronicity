...
def write_to_excel(df, workbook_path, sheet_name="data_etfFullMetrics"):
...
final_columns = [
'Ticker', 'longName', 'category', 'fundFamily', 'typeDisp', 'fullExchangeName',
    'fiftyTwoWeekLow', 'fiftyTwoWeekHigh', 'fiftyTwoWeekChangePercent',
    'netExpenseRatio', 'totalAssets', 'netAssets', 'navPrice',
    'ytdReturn', 'beta3Year', 'threeYearAverageReturn', 'fiveYearAverageReturn', 'trailingThreeMonthReturns',
    'trailingThreeMonthNavReturns', 'dividendYield', 'trailingAnnualDividendYield', 'trailingAnnualDividendRate',
    'dividendDate', 'fiftyDayAverage', 'fiftyDayAverageChange', 'fiftyDayAverageChangePercent', 'twoHundredDayAverage',
    'twoHundredDayAverageChange', 'twoHundredDayAverageChangePercent',
    'firstTradeDateMilliseconds', 'Timestamp'

]

rename_map = {
'Ticker': 'Ticker', 'longName': 'Name',
    'category': 'Category', 'fundFamily': 'Family',
    'typeDisp': 'Type', 'fullExchangeName': 'Exchange',
    'fiftyTwoWeekLow': '52w Low',
    'fiftyTwoWeekHigh': '52w High', 'fiftyTwoWeekChangePercent': '52w % Chg',
    'netExpenseRatio': 'Exp R', 'totalAssets': 'T Assets', 'netAssets': 'Net Assets',
    'bookValue': 'BV', 'navPrice': 'NAV', 'sharesOutstanding': 'Sh',
    'ytdReturn': 'ytd %', 'beta3Year': 'Beta', 'threeYearAverageReturn': '3y Avg %',
    'fiveYearAverageReturn': '5y Avg %', 'trailingThreeMonthReturns': 'T3m %',
    'trailingThreeMonthNavReturns': 'T3m % NAV', 'dividendYield': 'Div Yield',
    'trailingAnnualDividendYield': 'TTM Div Yield', 'trailingAnnualDividendRate': 'TTM Div Rate',
    'dividendDate': 'Div Date', 'fiftyDayAverage': '50d Avg', 'fiftyDayAverageChange': '50d Chg',
    'fiftyDayAverageChangePercent': '50d % Chg', 'twoHundredDayAverage': '200d Avg',
    'twoHundredDayAverageChange': '200d Chg', 'twoHundredDayAverageChangePercent': '200d % Chg',
    'firstTradeDateMilliseconds': 'First Trade', 'Timestamp': 'Timestamp'
...
try:
    ...
    df_final.to_csv(ETF_OUTPUT, index=False)
