...
def write_to_excel(df, workbook_path, sheet_name="data_mutualFullMetrics"):
...
final_columns = [
'Ticker', 'longName', 'typeDisp', 'fullExchangeName',
    'beta3Year', 'fiftyTwoWeekHigh', 'fiftyTwoWeekLow',
    'fiftyTwoWeekChangePercent', 'totalAssets', 'netAssets',
    'trailingThreeMonthReturns', 'ytdReturn', 'yield', 'annualReportExpenseRatio',
    'annualHoldingsTurnover', 'lastCapGain',
    'morningStarRiskRating', 'morningStarOverallRating', 'lastDividendValue',
    ...
    'fundInceptionDate', 'firstTradeDateMilliseconds', 'Timestamp'
]

rename_map = {
'Ticker': 'Ticker', 'longName': 'Name', 'typeDisp': 'Type',
    'fullExchangeName': 'Exchange', 'beta3Year': 'Beta',
    'fiftyTwoWeekHigh': '52w High', 'fiftyTwoWeekLow': '52w Low',
    'fiftyTwoWeekChangePercent': '52w % Chg',
    'totalAssets': 'Total Assets', 'netAssets': 'Net Assets',
    'ytdReturn': 'Return (TTM)', 'yield': 'Yield', 'annualReportExpenseRatio': 'Expense R',
    'annualHoldingsTurnover': 'Holding Turnover', 'lastCapGain': 'Last Capital Gain',
    'trailingThreeMonthReturns': 'Return (3m)',
    'morningStarRiskRating': 'Risk Rating', 'morningStarOverallRating': 'Overall Rating',
    'lastDividendValue': 'Last Div', 'dividendRate': 'Div Rate', 'dividendYield': 'Div Yield',
    'trailingAnnualDividendRate': 'Div Rate (TTM)', 'trailingAnnualDividendYield': 'Div Yield (TTM)',
    'firstTradeDateMilliseconds': 'First Trade', 'fundInceptionDate': 'Inception',
    'fiftyDayAverage': '50d Avg', 'fiftyDayAverageChange': '50d Chg',
